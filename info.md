## I got the "It seems that some tags are a bit cooked" Error, What do I do?!
...
For anyone who wants to remove the warning from chat, you can include this var arg within the JV Arguments on the server and/or client: `-Dlmft.disable_error_output=true`
